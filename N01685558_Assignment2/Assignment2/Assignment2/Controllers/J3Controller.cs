...
namespace Assignment2.Controllers
{
    ...
    public class J3Controller : ControllerBase
    {
        ...
        /// <example>
        /// please not the "+" will not work in curl as it is considered as a space so instead, use %2B which is "+"
        /// curl -X "GET" https://localhost:7204/api/J3/HarpTuning?tune=AFB%2B8
        /// -> AFB tighten 8
        /// https://localhost:7204/api/J3/HarpTuning?tune=AFB-8
        /// -> AFB loosen 8
        /// </example>
